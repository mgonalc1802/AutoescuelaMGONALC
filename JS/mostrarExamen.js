                            ...
                            fetch("API/preguntaApi.php",
                            {
                                ...
                                .then(y => 
                                {
                                    ...
                                    for(let i = 0; i < y.length; i++)
                                    {
                                        ...
                                        pregAux.getElementsByClassName("id")[0].innerHTML = y[i][0].id;
                                        pregAux.getElementsByClassName("enunciado")[0].innerHTML = y[i][0].enunciado;
                                        pregAux.getElementsByClassName("respuesta1")[0].innerHTML = y[i][0].respuesta1;
                                        pregAux.getElementsByClassName("respuesta2")[0].innerHTML = y[i][0].respuesta2;
                                        pregAux.getElementsByClassName("respuesta3")[0].innerHTML = y[i][0].respuesta3;
                                        ...
                                        recurso.src = y[i][0].url;
        
                                        //Lo añade a la pregunta
                                        pregAux.getElementsByClassName("recurso")[0].appendChild(recurso);
        
                                        //Resto de atributos
                                        pregAux.getElementsByClassName("idCategoria")[0].innerHTML = y[i][0].idCategoria;
                                        pregAux.getElementsByClassName("idDificultad")[0].innerHTML = y[i][0].idDificultad;
